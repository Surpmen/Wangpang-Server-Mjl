...
/*文件传输控制层类*/
@Api(value = "filetransfer", tags = "该接口为文件传输接口，主要用来实现文件的上传和下载")
@RestController
@Slf4j
...
public class FiletransferController {
    ...
    @ApiOperation(value = "实现文件极速上传", notes = "校验文件MD5判断文件是否存在，如果存在直接上传成功并返回skipUpload=true，如果不存在返回skipUpload=false需要再次调用该接口的POST方法", tags = {"filetransfer"})
     ...
     * @return
     */
    @ApiOperation(value = "上传文件", notes = "实现具体文件的上传接口", tags = {"filetransfer"})
